...
public sealed class JyroLinkingResult
{
    ...
    /// </summary>
    /// <value>
    /// A <see cref="LinkedProgram"/> instance containing the executable program
    ...
    /// </summary>
    /// <value>
    /// A <see cref="LinkingMetadata"/> instance providing performance
    /// and statistical data about the linking process.
    /// </value>
    public LinkingMetadata Metadata { get; }
}