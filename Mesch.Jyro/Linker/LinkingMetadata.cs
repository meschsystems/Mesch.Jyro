...
/// </summary>
public sealed class LinkingMetadata
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LinkingMetadata"/> class
    ...
    /// </param>
    public LinkingMetadata(TimeSpan linkingProcessingTime, int resolvedFunctionCount, DateTimeOffset linkingStartedAt)
    {
