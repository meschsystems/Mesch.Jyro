...
/// <summary>
/// Checks if any element in an array satisfies a comparison condition on a specified field.
/// Short-circuits on first match for efficiency. Returns false for empty arrays.
/// Supports nested field paths using dot notation (e.g., "address.city") and comparison operators
/// (==, !=, &lt;, &lt;=, &gt;, &gt;=).
/// </summary>
public sealed class AnyFunction : JyroFunctionBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AnyFunction"/> class
    /// with a signature that accepts an array, field name, comparison operator, and value.
    /// </summary>
    public AnyFunction() : base(new JyroFunctionSignature(
        "Any",
        [
    ...
    /// <summary>
    /// Executes the any-match check on the array of elements.
    /// </summary>
    ...
    /// <returns>
    /// <see cref="JyroBoolean.True"/> if any element matches the condition, <see cref="JyroBoolean.False"/> otherwise.
    /// Returns false for empty arrays. Non-object elements are skipped.
    /// </returns>
    ...
    public override JyroValue Execute(IReadOnlyList<JyroValue> arguments, JyroExecutionContext executionContext)
    {
        ...
        for (int i = 0; i < array.Length; i++)
        {
            ...
            // Evaluate the comparison - short-circuit on first match
